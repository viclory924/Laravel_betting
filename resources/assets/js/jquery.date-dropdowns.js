...
;(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        buildDayDropdown: function () {
            ...
            dropdown.append(option).attr('data-placeholder', this.config.dayLabel).addClass('calendar-select');
        ...
        buildMonthDropdown: function () {
            ...
            for (var monthNo = 1; monthNo <= 12; monthNo++) {
                ...
                dropdown.append(option).attr('data-placeholder', this.config.monthLabel).addClass('calendar-select');
            }
        ...
        buildYearDropdown: function () {
            ...
            for (var i = maxYear; i >= minYear; i--) {
                ...
                dropdown.append(option).attr('data-placeholder', this.config.yearLabel).addClass('calendar-select');
            }
